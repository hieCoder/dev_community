...
@Component
public class OutstandingPostHotTopicUtil {

    private final float RATIO_VIEW_POST_LATEST_GREATEST = 0.1f;
    private final float RATIO_LIKE_POST_LATEST_GREATEST = 0.2f;
    private final float RATIO_SHARE_POST_LATEST_GREATEST = 0.3f;
    private final float RATIO_COMMENT_POST_LATEST_GREATEST = 0.15f;
    private final float RATIO_USER_READING_TIME_POST = 0.05f;
    private final float RATIO_USER_READ_FULL_POST = 0.2f;
    ...
    private float getScoreOfComment(long commentCount) { return commentCount * RATIO_COMMENT_POST_LATEST_GREATEST; }
