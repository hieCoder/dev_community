...
public enum EActionNotification {
    ...
    CREATE_COMPONENT( "A new component named {title} has been created successfully."),
    UPDATE_COMPONENT("The component named {title} has been updated."),
    DELETE_COMPONENT("The component named {title} has been deleted.");
